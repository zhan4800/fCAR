function [theta,flag,Vbetans,Wv]=UpdateTheta1(beta,theta,Vbetans,Wv,D,W,model,a,b,propsd_Theta,wavespecs,MCMCspecs,Rinv)
...
[~,Vbetans_new,Wv_new]=GetGCP_cor1(theta_new,W,Rinv,model,wavespecs,1,D,MCMCspecs);
