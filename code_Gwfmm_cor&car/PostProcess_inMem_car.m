function [betahat,beta_025CI,beta_975CI,alphahat,accept_rate_theta,ghat,ghatns,Q025_ghat,Q975_ghat,thetahat,rhohat, theta_025CI,theta_975CI,tauhat,pihat,...
...
Q975_ghat=zeros(p,T);
ghat=NaN(p,T);
% check here: if it needs to insert back the zero-coefficient wavelet
