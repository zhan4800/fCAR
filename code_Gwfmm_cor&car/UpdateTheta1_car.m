function [theta,flag,Vbetans,Wv]=UpdateTheta1_car(beta,theta,Vbetans,Wv,D,W,model,a,b,propsd_Theta,wavespecs,MCMCspecs,Rivmat)
...
%[~,Vbetans_new,Wv_new]=GetGCP_byblocks(theta_new,D,W,model,wavespecs,1,MCMCspecs);
[~,Vbetans_new,Wv_new]=GetGCP_car(theta_new,W,Rivmat,model,wavespecs,1,D,MCMCspecs);
